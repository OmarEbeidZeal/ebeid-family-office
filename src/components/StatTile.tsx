        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button
              ...
              className="-m-2 rounded-sm p-2 coarse:-m-3 coarse:p-3 text-muted-foreground/50 opacity-0 transition-opacity focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring group-hover:opacity-100 coarse:opacity-100"
            >
